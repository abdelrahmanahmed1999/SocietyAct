...
<head>
    ...
    <meta http-equiv="Content-language" content="ar"/>
        <title>ادخال أنشطة خدمة المجتمع</title>
...
$stmt = $con->prepare($q);
 ...
 $res = $stmt->get_result();
	...
	$serial=$row['serial'];
		...
		$gehaaa= $row ['gehaaa']; 
		$wafed_studentnnn=$wafed_student;
	//echo "hhh".$wafed_studentnnn;
    ...
    <div align="right">
        <table width="475" border="0" dir="rtl" class="table table-striped">
		  ...
		  <tr>
                ...
                <td dir="rtl">
                    <div align="right">
                        <select name="univselect" id="univselect" class="form-control" style="width:250px" 
...
<!------------------------------------------------>
	  <tr>
                ...
                <td dir="rtl">
                    <div align="right">
					<select name="taklefselect" id="taklefselect"  class="form-control" style="width:250px"  onchange="validateForm()"> 
...
<tr>
                ...
                <td dir="rtl">
                          ...
                          <input type="text" id="tak" name="tak" class="form-control" style="width:250px"  readonly value ="<?php  echo $gehaaa; ?>" > 
...
<?php } ?>				
              <tr>
                ...
                <td dir="rtl">
                    <div align="right">
                        <input type="date" id="date" name="date"  class="form-control" style="width:250px"  readonly value ="<?php  echo $Date; ?>" >
                    </div>
                </td>
                    </div>
                </td>
			...
			<!------------------------------------------------>
              <tr>
                ...
                <td dir="rtl">
                    <div align="right">
                        <input type="date" id="End_date" name="End_date"   class="form-control" style="width:250px"  readonly value ="<?php  echo $End_Date; ?>" >
                    </div>
                </td>
                    </div>
                </td>
                ...
                <td dir="rtl">
                    <div align="right">
                        <textarea name="b_enroll_male" class="form-control" style="width:250px"   readonly ><?php  echo $title; ?>  </textarea>
 ...
 oninput="setCustomValidity('')"  />
            ...
            <!------------------------------------------------>
                ...
                <td dir="rtl">
                    <div align="right">
                        <input type="text" id="wafed_student" name="wafed_student"   class="form-control" style="width:250px"  readonly value ="<?php  echo $wafed_studentnnn; ?>"  />
                    </div>
                </td></tr>
<!--------------------------------------------->
			  <tr>
                ...
                <td dir="rtl">
                    <div align="right">
                        <input type="number" id="egy_student" name="egy_student"  class="form-control" style="width:250px"   readonly value ="<?php  echo $egy_student; ?>"  />
                    </div>
                </td></tr>
<!--------------------------------------------->
			  <tr>
                ...
                <td dir="rtl">
                    <div align="right">
                        <input type="number" id="khas_student" name="khas_student" class="form-control" style="width:250px"   readonly value ="<?php  echo $khas_student; ?>"   />
                    </div>
                </td></tr>
            ...
            <!------------------------------------------------>
                ...
                <td dir="rtl">
                    <div align="right">
                        <input type="number" id="no_student" name="no_student"  class="form-control" style="width:250px"  readonly value ="<?php  echo $no_student; ?>"  >
									<oninvalid="this.setCustomValidity('يجب اختيار اسم النشاط')"
 oninput="setCustomValidity('')"  />
                    </div>
                </td></tr>
 ...
 <tr>
                ...
                <td dir="rtl">
                    <div align="right">
                      <textarea name="comment" rows="5" cols="40"   class="form-control" style="width:250px"  readonly > <?php  echo $activity_desc; ?> </textarea>
                    </div>
                </td>
                    </div>
                </td>
