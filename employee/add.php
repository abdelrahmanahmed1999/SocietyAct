...
if (($univname !="")&&($topicname !="")&&($typename !="")&&($taklefname != ""))
{
echo '
<div align="center"><strong><u>  بيان ب'.$topicname.' '.$typename.' ب'.$taklefname.'  بجامعة  '.$univname.' </u> </strong></div>';
}
else
{
}
...
where `activity`.`activity_natural_ID`=activity_natural.ID  and `activity`.`activity_top_ID`= 1
