...
if($id==1)
{
	$reportTitle = "أنــشــطة خدمــة المــجتــمع التى تمت بالفعل";
}
else if($id==2)
{
	$reportTitle = "خطة الأنشطة  المستقبلية";
}
$reportUniversityImg="";
...
if (isset($_POST['search']))
{
 ...
 $topicnameheader = $row['name'];  				
	...
	if (isset($_POST['wafed_student'])){
		...
		$wafed_student_title="عدد المستفيدين  ";
	}
	else
	{
		$wafed_studentq="";
	...
	if (isset($_POST['khas_student'])){
		...
		$khas_student_title="عدد المشاركين  ";
	}
	else
	{
		$khas_studentq="";
...
<?php
				    ...
				    <?php  if (isset($_POST['wafed_student']) && (($_POST['wafed_student'])== '0'))
   {
	  ...
	  <label for="wafed_student"> عدد المستفيدين</label>
<?php   }
else
{
...
<?php }	?>
              ...
              <tr>
					...
					<td>                    <div align="right">بــيــان بأعــداد</div> </td>
									    ...
									    <?php  if (isset($_POST['egy_student']) && (($_POST['egy_student'])== '1'))
   {
      ?>       <input type="checkbox" id="egy_student" name="egy_student" value="1" checked>
                    <label for="egy_student">  عدد القوافل</label>
<?php   }
else
{
...
<?php }	?>
														    ...
														    <?php  if (isset($_POST['khas_student']) && (($_POST['khas_student'])== '2'))
   {
      ?>       				 <input type="checkbox" id="khas_student" name="khas_student" value="2" checked> 
                    <label for="khas_student">  عدد المشاركين</label>
<?php   }
else
{
...
<td colspan="2">
<div align="right"><strong style="color:blue"> بيان بأعداد : ' .  $student_title . ' </strong></div>
</td>
