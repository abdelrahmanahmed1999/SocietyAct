...
$id = $_GET['id'];
if($id==1)
	$reportTitle = "تقرير بالأنشطة الطلابية التى تمت بالفعل";
else if($id==2)
...
{
?>
<input type="date" id="End_date" name="End_date" class="form-control" style="width:250px" >
<?php
}?>	
			...
			<!------------------------------------------------>
				 ...
				 <td>
				  ...
				  <td>
				    <?php  if (isset($_POST['wafed_student']) && (($_POST['wafed_student'])== '0'))
   {
      ?>       <input type="checkbox" id="wafed_student" name="wafed_student" value=<?php echo $_POST['wafed_student'];?>  checked>
	  <label for="wafed_student"> الطلاب الوافدين</label>
<?php   }
else
{
	  ?>  <input type="checkbox" id="wafed_student" name="wafed_student" value="0" >
	  <label for="wafed_student"> الطلاب الوافدين</label>
<?php }	?>
              ...
              <tr>
					...
					<td>                    <div align="right">الطلاب المشتركين</div> </td>
					...
					<td>
									    ...
									    <?php  if (isset($_POST['egy_student']) && (($_POST['egy_student'])== '1'))
   {
      ?>       <input type="checkbox" id="egy_student" name="egy_student" value="1" checked>
                    <label for="egy_student">  الطلاب المصريين</label>
<?php   }
else
{
	  ?>  <input type="checkbox" id="egy_student" name="egy_student" value="1">
                    <label for="egy_student">  الطلاب المصريين</label>
<?php }	?>
				...
				<td></td>
					<td>
														    ...
														    <?php  if (isset($_POST['khas_student']) && (($_POST['khas_student'])== '2'))
   {
      ?>       				 <input type="checkbox" id="khas_student" name="khas_student" value="2" checked> 
                    <label for="khas_student">  الطلاب ذوى الاحتياجات الخاصة</label>
<?php   }
else
{
	  ?>				 <input type="checkbox" id="khas_student" name="khas_student" value="2"> 
                    <label for="khas_student">  الطلاب ذوى الاحتياجات الخاصة</label>
<?php }	?>
...
<div align="right"><strong style="color:blue"> الطلاب المشتركين : ' .  $tolabnameheader . ' </strong></div>
<div align="right"><strong style="color:blue"> جزء من اسم النشاط : ' .   $nashat_nameqheader . ' </strong></div>
 
<div align="center"><strong style="color:blue">' . $dateheader . ' ' . $End_dateheader . '</strong></div>
...
<img src="'.$logo_path.'"  width="100" height="100"  class="web"/>';
?>
<?php
echo'
<strong style="color:blue">الجامعة : ' . $univnameheader . ' </strong>
</div>
<div align="right"><strong style="color:blue">طبيعة النشاط : ' . $topicnameheader . '</strong></div>
<div align="right"><strong style="color:blue">نوعية النشاط : ' . $typenameheader . '    </strong></div>
<div align="right"><strong style="color:blue">نوعية التكليف : ' .  $taklefnameheader . ' </strong></div>
<div align="right"><strong style="color:blue"> الطلاب المشتركين : ' .  $tolabnameheader . ' </strong></div>
<div align="right"><strong style="color:blue"> جزء من اسم النشاط : ' .   $nashat_nameqheader . ' </strong></div>
<div align="center"><strong style="color:blue">' . $dateheader . ' ' . $End_dateheader . '</strong></div>
';
